...
class quiz_archive_report extends quiz_default_report {
    ...
    /** @var array the students who took this quiz. */
    protected $students;

    /**
     * Displays the archive report.
     */
    ...
    protected function display_archive() {
        global $OUTPUT, $PAGE;
        $studentattempts = $this->quiz_report_get_students_and_attempts($this->quiz);
        foreach ($studentattempts as $studentattempt) {
            echo $this->quiz_report_get_student_attempt($studentattempt['attemptid']);
        }
    }
     ...
     *         ->userid, ->attemptid.
     */
    protected function quiz_report_get_students_and_attempts($quiz) {
        global $DB;
    ...
    /**
     * Gets the student's attempt.
     *
     * @param $attemptid the attempt id
     * @return string
     */
    protected function quiz_report_get_student_attempt($attemptid) {
        global $DB, $PAGE;
